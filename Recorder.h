...
int compressData() {
    ...
    if((lastAirPressure != airPressure && airPressure > 4000 && airPressure < 15000) || DISABLE_MEMORY_COMPRESSION) { // My Weather Station Module had problems with reporting the correct air pressure, so any low readings are discarded
